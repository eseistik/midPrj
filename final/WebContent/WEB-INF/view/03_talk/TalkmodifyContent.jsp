...
<body>
	...
	<div class="container" style="width: 1200px;">
		...
		<div id="contents_area" class="col-xs-9">
			...
			<form name="talkForm" action="talkmodify.action" id="talkForm" method="get"
				...
				<div class="cs_write">
					...
					<textarea id="t_content" name="t_content"
						class="form-control fixed" style="height: 200px;"> ${viewContents.t_content }</textarea>
					<div class="blank_bottom"></div>
					...
					<div class="form-group">
						...
						<label for="t_img"> <img id="blah1"
							src="${viewContents.t_img }" style="height: 300px;">
