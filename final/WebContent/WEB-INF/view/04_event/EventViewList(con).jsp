				...
				<c:forEach var="eventList" items="${list }">
					<div class="media">
						<div class="media-left" style="position: relative">
							<a href="/99_Dispatcher/eventContent.action?event_id=${eventList.event_id }" ><img
								class="media-object"
						...
						<div class="media-body">
							<h2 class="media-heading" id="top-aligned-media">
								<span class="info_cate">[ ${eventList.event_stu_val} ]</span>
								 <a href="/99_Dispatcher/eventContent.action?event_id=${eventList.event_id }">${eventList.event_title}</a>
							</h2>
