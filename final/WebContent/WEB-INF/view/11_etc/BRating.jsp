...
<script type="text/javascript">
	function popover_submit() {
		var b_star_score = $('#b_star_score').html();
		var b_id = document.getElementById("b_id").value;
		var u_id = document.getElementById("u_id").value;
		
		$("#rating-form").attr("action", "BratingFin.action?b_star_score=" + b_star_score + "&b_id=" + b_id + "&u_id=" + u_id).submit();
	}
		...
		<div class="rating-body col-md-12" style="height: 150px;">
			<form id="rating-form" method="post">
				<div class="rating" data-vote="0">
					<div class="star-category">브랜드 점수</div>
					...
					<div class="score">
						<span class="score-rating js-score" id="b_star_score">0</span> <span>/</span>
