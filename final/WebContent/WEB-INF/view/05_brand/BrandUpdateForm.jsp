...
function doSubmit(date)
{
	...
	form.action="/99_Dispatcher/brandupdate.action";
	form.submit();
			...
			<div class="insert_center">
				...
				<div class="cont_box pad_l_60">
					...
					<div class="cont_line pad_b_25">
						...
						<textarea id="brand_intro" name="brand_intro"
							...
							placeholder="예) 둘이 먹다 하나 죽어도 모르는 맛.">${main.b_content }</textarea>
					</div>
				...
				<div class="cont_box pad_l_60">
					...
					<div class="cont_line">
						...
						<input type='text' class='form-control' style='width: 100px;' id='big_${status.count }' name='big' readonly='readonly' value='${mate.big_ing_name }'>
						<input type='text' class='form-control' style='width: 150px;' id='mid_${status.count }' name='mid' readonly='readonly' value='${mate.mid_ing_name }'>
						<input type='text' class='form-control' style='width: 80px;' id='mass_${status.count }' name='mass' readonly='readonly' value='${mate.b_ing_weight }'>
						<input type='text' class='form-control' style='width: 80px;' id='unit_${status.count }' name='unit' readonly='readonly' value='${mate.unit_name }'>
					...
					<div id="sortable2" class="ui-sortable">
						...
						<div id="step_${status.count }" class="step" onmouseover="view(${status.count })" onmouseout="view2(${status.count })">
							...
							<div id="recipe_stepText_${status.count }">
								<textarea name="stepText" id="stepText_${status.count }" style="margin: 0 -4px 0 -3px;" class="form-control step_cont" placeholder="양파는 사각으로 썰어주세요.">${step.b_step_content }</textarea>
							</div>
							<div id="stepImg_${status.count }">
								<img id="stepImgHolder_${status.count }">
							</div>
					...
					<div id="complete_picArea" class="ui-sortable">
						...
						<div id="complete_picUpload_${status.count }" class="complete_pic">
							...
							<input type="hidden" name="complete_photo"
								id="complete_photo_${status.count }" value=""> 
								<input type="hidden" name="complete_photo_new" id="complete_photo_new_${status.count }" value="">
							<input type="hidden" name="complete_photo_del"
								id="complete_photo_del_${status.count }" value="">

							<div id="pic_input">
								<input type="file" name="com_pic_${status.count }" id="com_pic_${status.count }" value="${cl.b_cl_img }">
							</div>

							<div id="complete_picBox_${status.count }" is_over="0">
								<a href="#" class="pic_del"></a> <img id="com_photoHolder_${status.count }"
									onclick="" src="<%=cp%>/images/insert/pic_none3.gif"
									alt="No Image">
							</div>
						</div>
						</c:forEach>
				...
				<div class="cont_box pad_l_60">
					<div class="cont_line">
						...
						<input type="text" name="brand_link" id="brand_link"
							class="form-control" value="${main.b_url }">
					</div>
