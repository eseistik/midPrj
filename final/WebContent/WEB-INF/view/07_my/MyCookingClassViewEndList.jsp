...
function cookingclassInfo(val) {
	...
	//테스트
	//alert(cc_id);
	var popUrl = "cookingInfo.action?cc_id=" + cc_id; //팝업창에 출력될 페이지 URL
		...
		<div class="row">
			...
			<div class="col-sm-8 blog-main">
				...
				<ul class="nav nav-tabs" id="ui-nav-list">
					...
					<li role="presentation" class="active"><a href="myCookingEnd.action">종료된 클래스</a></li>
					<li role="presentation"><a href="myCookingCource.action">진행 중인 클래스</a></li>
					<li role="presentation"><a href="myCookingEndCource.action">진행 종료된 클래스</a></li>
				</ul>
				...
				<div class="divTable greyGridTable col-md-12">
					<div class="divTableHeading">
						<div class="divTableRow">
							...
							<div class="divTableHead">예약일(결제번호)</div>
							<div class="divTableHead">시작 일자</div>
							<div class="divTableHead">종료 일자</div>
					...
					<div class="divTableBody">
						<c:forEach var="cookingclass" items="${cookingclass }">
							<div class="divTableRow">
								...
								<div class="divTableCell">${cookingclass.cc_re_num }</div>
								<div class="divTableCell">${cookingclass.min }</div>
								<div class="divTableCell">${cookingclass.max }</div>
								<div class="divTableCell">${cookingclass.cc_title }</div>
								<div class="divTableCell">
									<button type="button" class="btn btn-xs btn-default" onclick="cookingclassInfo('${cookingclass.cc_id }');">정보</button>
									<button type="button" class="btn btn-xs btn-default">환불</button>
								</div>
							</div>
						</c:forEach>
					</div>
