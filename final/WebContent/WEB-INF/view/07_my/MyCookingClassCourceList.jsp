		...
		<div class="row">
			...
			<div class="col-sm-8 blog-main">
				...
				<ul class="nav nav-tabs" id="ui-nav-list">
					...
					<li role="presentation" class="active"><a href="myCookingCource.action">진행 중인 클래스</a></li>
				...
				<div class="divTable greyGridTable col-md-12">
					...
					<div class="divTableBody">
						<c:forEach var="cookingclass" items="${cookingclass }">
							<div class="divTableRow">
								<div class="divTableCell cookId">${cookingclass.cc_id }</div>
								<div class="divTableCell cookTitle">${cookingclass.cc_title }</div>
								<div class="divTableCell cookPeople">${cookingclass.people }</div>
