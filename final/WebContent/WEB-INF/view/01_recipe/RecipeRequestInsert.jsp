...
<script type="text/javascript">
	...
	function reqeustInsert() {
		...
		if (content == "" || content == null) {
			...
			alert("열 글자 이상의 내용을 입력해 주세요.");
			return;
		}
		
		var form = document.getElementById("requestInsertForm");
		
		form.action = "/99_Dispatcher/requestinsert.action";
...
<body>
	...
	<div class="container" style="width: 1200px;">
		...
		<div id="contents_area" class="col-xs-9">
			...
			<form name="requestInsertForm" id="requestInsertForm" method="get"
				action="requestInsert.action" style="margin-top: 10px;">
				...
				<div class="cs_write">
					...
					<input type="hidden" id="u_id" name="u_id" value="coyo4">

					<div class="blank_bottom"></div>
					<div class="btn-group-lg col-lg-12" role="group" align="center"
						style="margin-top: 30px;">
						<button type="button" class="btn-lg" onclick="reqeustInsert();"
							style="color: black; background-color: white; border: 1px solid #e9e9e9">등록하기</button>
